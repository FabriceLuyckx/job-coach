...
How the app reads external web pages headlessly — job listing pages, posting
pages, and CV HTML for PDF export — so that real-world pages (chatty SPAs,
blocked font CDNs) are read reliably instead of failing on idealized load
conditions.
