...
Let a packaged installation of the application update itself from the
project's GitHub Releases, safely and only on explicit user approval, without
requiring a reinstall or losing user data.
