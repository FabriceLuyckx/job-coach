...
Give each application on the Applications page a single per-listing language that
governs both its tailored CV and its cover-letter guide — detected automatically
for new pastes, inherited from accepted suggestions, changeable in one place, and
cancellable while it regenerates.
